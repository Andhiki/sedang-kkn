...
class KKN:
  ...
  #     if not (new_entries := await self.get_logbook_entries_by_id(p_id)):
  #         print_log(f"No entries found for {self.main_program[p_id]['title']}", "ERROR")
  #         return
  #
  #     self.main_program[p_id]["entries"] = new_entries
